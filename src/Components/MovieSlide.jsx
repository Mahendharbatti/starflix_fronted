                ...
                <div className="slide-left">
                  <div className="badges">
                    {movie.genres.map((genre, i) => (
                      <span key={i} className={`badge genre-${genre.toLowerCase()}`}>
                        {genre}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="buttons">
                    <Button variant="outline-info" onClick={() => navigate(`/movies/${slugify(movie.title)}`)}
                  ...
                  <Button className="detail-btn" variant="info" onClick={() => navigate(`/movies/${slugify(movie.title)}`)}
                    style={{ cursor: "pointer" }}>
                    MORE DETAIL
                  </Button>
                </div>

                <div className="slide-right" onClick={() => navigate(`/movies/${slugify(movie.title)}`)}
                  style={{ cursor: "pointer" }}>
