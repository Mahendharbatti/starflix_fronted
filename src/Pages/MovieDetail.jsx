...
import { FaCreditCard, FaHeart, FaPlay, FaShareAlt, FaStar,FaStarHalfAlt } from "react-icons/fa";
...
const movies = [
    //english movies
    {
        title: "OPPENHEIMER", image: "images/movies/oppenheimer.png", rating: "8.3", language: "ENGLISH",
        url: "https://www.youtube.com/embed/uYPbbksJxIg?si=BIhAnmSjZOnnHYXj",
        description: "Oppenheimer is a 2023 epic biographical thriller film written, produced, and directed by Christopher Nolan. It follows the life of J. Robert Oppenheimer, the American theoretical physicist who helped develop the first nuclear weapons during World War II.",
        director: "Christopher Nolan", stars: "	Cillian Murphy,Emily Blunt,Matt Damon,Robert Downey Jr.,Florence Pugh,Josh Hartnett,Casey Affleck",
        genres: "Biography, Drama, History ",
        release: "July 21, 2023", runtime: "180 minutes",

        producer:"Christopher Nolan",
         cast: [
            { name: "Cillian Murphy", role: "as J. Robert Oppenheimer " },
            { name: "Emily Blunt", role: "as Kitty Oppenheimer" },
            { name: "Robert Downey Jr.", role: "as Lewis Strauss" },
            { name: "Florence Pugh", role: "as Jean Tatlock " }
        ],
    ...
    {
        title: "AVATAR The way of water", image: "images/movies/avatar.png", rating: "8.8", language: "ENGLISH",
        ...
        release: "16 Dec, 2022", runtime: "	192 minutes",
         
        producer:"Jon Landau",
         cast: [
            { name: "Sam Worthington", role: "as Jake" },
            { name: "Zoe Saldana", role: "as Neytiri" },
            { name: "Sigourney Weaver", role: "as Kiri" },
            { name: "Stephen Lang", role: "as Quaritch" }
        ],
    ...
    {
        title: "AVENGERS", image: "images/movies/avengers.png", rating: "8.4", language: "ENGLISH",
        ...
        release: "April 26, 2019", runtime: "181 minutes",
         
        producer:"Kevin Feige",
         cast: [
            { name: "Robert Downey Jr.", role: "as Tony Stark / Iron Man" },
            { name: "Chris Evans", role: "as Steve Rogers / Captain America " },
            { name: "Mark Ruffalo", role: "as Bruce Banner / Hulk" },
            { name: "Chris Hemsworth", role: "as Thor" }
        ],
    ...
    {
        title: "PIRATES OF THE CARIBBEAN", image: "images/movies/piratesofthecaribbean.png", rating: "7.0", language: "ENGLISH",
        ...
        release: "May 26, 2017", runtime: "129 minutes",
         
        producer:"Jerry Bruckheimer",
         cast: [
            { name: "Johnny Depp", role: "as Captain Jack Sparrow" },
            { name: "Javier Bardem", role: "as Captain Salazar" },
            { name: "Brenton Thwaites", role: "as Henry Turner" },
            { name: "Kaya Scodelario", role: "as Carina Smyth" }
        ],
        ...
        reviews: [
            {
                ...
                user: "Prudhvi ",
                daysAgo: 45,
                text: "After watching with very low expectations to 'Pirates of the Caribbean: Dead Men Tell No Tales', it is hard to understand the legion of haters that write in IMDb. The film is not a masterpiece but is funny, entertaining, with great cast, special effects, screenplay and story. Johnny Depp performs the wolf, drunken and smart Captain Jack Sparrow in the usual funny way. Cinema lovers of fantasy-adventure genre must ignore the bad reviews and question what this kind of people that writes that the movie is not good like to see or if they have difficulties to understand a story with many characters."
            },
            {
                rating: 4,
                user: "raju",
                daysAgo: 58,
                text: "Nice addition to the saga but still not as good as the old ones...I m a 30+ old big fan of the Pirates of Caribbean movies and absolutely love what Gore Verbinski did with the first 3. I was utterly disappointed with the previous potc movie (#4). I went to watch this new one with a lot of prejudice. But luckily it was an epic and fun movie to watch! Extremely entertaining and connected with Verbinski's style and work. Lots of beautiful action scenes, nice landscapes, humour and never ever, at any point boring. Jack Sparrow is definitely back in great form",
            }
        ]
    },
    ...
    {
        title: "INTERSTELLAR", image: "images/movies/interstellar.png", rating: "8.7", language: "ENGLISH",
        ...
        release: "November 7, 2014", runtime: "169 minutes",
         
        producer:"Christopher Nolan",
         cast: [
            { name: "Matthew McConaughey", role: "as Cooper" },
            { name: "Anne Hathaway", role: "as Brand" },
            { name: "Jessica Chastain", role: "as Murph" },
            { name: "John Lithgow", role: "as Donald" }
        ],
    ...
    {
        title: "THE BATMAN", image: "images/movies/thebatman.png", rating: "7.8", language: "ENGLISH",
        ...
        release: "March 4, 2022", runtime: "176 minutes",
         
        producer:"Dylan Clark",
         cast: [
            { name: "Robert Pattinson", role: "as Bruce Wayne/The Batman" },
            { name: "Zoe Kravitz", role: "as Selina Kyle" },
            { name: "Paul Dano", role: "as The Riddler" },
            { name: "Jeffrey Wright", role: "as Lt. James Gordon" }
        ],

        reviews: [
            {
                rating: 4,
                user: "Prudhvi Bachineni",
                daysAgo: 63,
            ...
            },
            {
                ...
                user: "Yogi",
                daysAgo: 88,
                text: "For a hero movie, three hours is a bold attempt; At the same time, with a serious tone of narrative, it is extremely brave challenge. Like 'The Joker', this novel tries its best to create a three-dimensional character; At the same time with a ups and downs of the story, the success of the character image more rich and full. At the expense of course, the other characters are somewhat weak compared to the main characters. And this also leads to some of the emotional depiction is a bit abrupt, which is regrettable. However, whether it is dazzling brilliance, or shocking sound effects, or excellent screenplay, a number of advantages all make this is a high-quality work that cannot be overshadowed by flaws.",
            }
        ]
    },
    ...
    {
        title: "THE MEG", image: "images/movies/themeg.png", rating: "5.7", language: "ENGLISH",
        ...
        release: "August 10, 2018 ", runtime: "113 minutes",
         
        producer:"Belle Avery",
         cast: [
            { name: "Jason Statham", role: "as Jonas Taylor" },
            { name: "Bingbing Li", role: "as Suyin" },
            { name: "Rainn Wilson", role: "as Morris" },
            { name: "Winston Chao", role: "as Zhang" }
        ],
        ...
        reviews: [
            ...
            },
            {
                ...
                user: "rajesh",
                daysAgo: 60,
                text: "Great special effects cover for some sketchy acting - not that anyone watches these sorts of movies for acting - and some of the expected action movie tropes (like my personal favourite: someone getting killed gloating about their victory after they think the threat is over) in what is a fun film if you like giant creature movies and Jason Statham. One of those movies to not over-think.",
            }
        ]
    },
    ...
    {
        title: "WARFARE", image: "images/war.png", rating: "7.3", language: "ENGLISH",
        ...
        release: "11 April 2025", runtime: "1h 38mins",
         
        producer:"Peter Rice",
         cast: [
            { name: "D'Pharaoh Woon-A-Tai", role: "as Ray" },
            { name: "Will Poulter", role: "as Erik" },
            { name: "Cosmo Jarvis", role: "as Elliott" },
            { name: "Joseph Quinn", role: "as Sam" }
        ],
    ...
    {
        title: "DANGAL", image: "images/movies/dangal.png", rating: "8.3", language: "HINDI",
        ...
        release: "December 21, 2016", runtime: "2h 40mins",
         
        producer:"Aamir Khan",
         cast: [
            { name: "Aamir Khan", role: "as Mahavir Singh Phogat" },
            { name: "Sakshi Tanwar", role: "as Daya Kaur" },
            { name: "Fatima Sana Shaikh", role: "as Geeta Phogat" },
            { name: "Sanya Malhotra", role: "as Babita Kumari" }
        ],
    ...
    {
        title: "FIGHTER", image: "images/movies/fighter.png", rating: "6.4", language: "HINDI",
        ...
        release: "25 January 2024", runtime: "166 minutes",
         
        producer:"Siddharth Anand",
         cast: [
            { name: "Hrithik Roshan", role: "as Squadron Leader Shamsher Pathania (Patty)" },
            { name: "Deepika Padukone", role: "as Squadron Leader Minal Rathore (Minni)" },
            { name: "Anil Kapoor", role: "as Group Captain Rakesh Jaisingh (Rocky)" },
            { name: "Karan Singh Grover", role: "as Squadron Leader Sartaj Gill (Taj)" }
        ],
    ...
    {
        title: "PATHAAN", image: "images/movies/pathaan.png", rating: "5.8", language: "HINDI",
        ...
        release: "January 25, 2023", runtime: "146 minutes",
         
        producer:"Aditya Chopra",
         cast: [
            { name: "Shah Rukh Khan", role: "as Pathaan" },
            { name: "Deepika Padukone", role: "as Rubai" },
            { name: "John Abraham", role: "as Jim" },
            { name: "Dimple Kapadia", role: "as Nandini" }
        ],
    ...
    {
        title: "12 FAIL", image: "images/movies/12fail.png", rating: "8.7", language: "HINDI",
        ...
        release: "27 October 2023", runtime: "146 minutes",
         
        producer:"Vidhu Vinod Chopra",
         cast: [
            { name: "Vikrant Massey", role: "as Manoj Sharma" },
            { name: "Medha Shankar", role: "as Shraddha Joshi" },
            { name: "Anant Joshi", role: "as Pritam Pandey" },
            { name: "Anshumaan Pushkar", role: "as Gaurinandan" }
        ],
    ...
    {
        title: "TIGER 3", image: "images/movies/tiger3.png", rating: "5.7", language: "HINDI",
        ...
        release: "12 November 2023", runtime: "156 minutes",
         
        producer:"Aditya Chopra",
         cast: [
            { name: "Salman Khan", role: "as Tiger (Avinash Rathod)" },
            { name: "Katrina Kaif", role: "as Zoya" },
            { name: "Emraan Hashmi", role: "as Aatish" },
            { name: "Simran", role: "as Nasreen Irani" }
        ],
        ...
        reviews: [
            {
                ...
                user: "kiran",
                daysAgo: 51,
                text: "Tiger (Salman Khan) is sent on a mission by his new boss Ms. Menon (Revathi) to save an old friend. He succeeds partially in the mission and gets a shocker of an information which shakes him. Enter the baddie Aatish Rehman (Emraan Hashmi) who used to be the mentor of Zoya (Katrina Kaif). The past and present get entangled, making things too personal for Tiger and Zoya. How they get out of this mess created by Aatish and save Pakistan out of all in the silliest plot the writers came up with, forms rest of the story."
            },
            {
                rating: 2,
                user: "rahul",
                daysAgo: 63,
                text: "Salman khan did the same monotonous low pitch voice in all his recent movies. Which is unbearable, annoying. No voice modulations, emotions and variations.. He probably tries to imitate Bobby deol silent action hero type acting. Like Soldier, Bichhoo, Gupt.. But Bobby Deol's low pitch voice is not annoying at all, it is soothing, while Salman's voice seems like he has flu and sore throat since a month.",
            }
        ]
    },
    ...
    {
        title: "KABIR SINGH", image: "images/movies/kabirsingh.png", rating: "7.0", language: "HINDI",
        ...
        release: "21 June 2019", runtime: "172 minutes",
         
        producer:"Naman Chouhan",
         cast: [
            { name: "Shahid Kapoor", role: "as Kabir Rajdheer Singh" },
            { name: "Kiara Advani", role: "as Preeti Sikka" },
            { name: "Nikita Dutta", role: "as Jia Sharma" },
            { name: "Soham Majumdar", role: "as Shiva" }
        ],
    ...
    {
        title: "CHHAAVA", image: "images/chaava.png", rating: "9.2", language: "HINDI",
        ...
        release: "14 Feb, 2025", runtime: "2h 41 mins", 
        producer:"Dinesh Vijan",

        cast: [
            { name: "Vicky Kaushal", role: "as Chhatrapati Sambhaji Maharaj" },
            { name: "Rashmika Mandanna", role: "as Yesubai Bhonsale" },
            { name: "Akshaye Khanna", role: "as Aurangzeb" },
            { name: "A. R. Rahman", role: "Musician" }
        ],
    ...
    //telugu movies
    {
        title: "RRR", image: "images/movies/rrr.png", rating: "7.8", language: "TELUGU",
        ...
        release: "March 25, 2022", runtime: "182 minutes",
         
        producer:"D.V.V. Danayya ",
         cast: [
            { name: "N.T.Rama Rao Jr.", role: "as Komaram Bheem" },
            { name: "Ram Charan", role: "as Alluri Sitarama Raju" },
            { name: "Ajay Devgn", role: "as Venkata Rama Raju" },
            { name: "Alia Bhatt", role: "as Sita" }
        ],
    ...
    {
        title: "SALAAR", image: "images/movies/salaar.png", rating: "8.2", language: "TELUGU",
        ...
        release: "22 December 2023", runtime: "175 minutes",
         
        producer:"Chaluve Gowda",
         cast: [
            { name: "Prabhas", role: "as Salaar / Deva" },
            { name: "Prithviraj Sukumaran", role: "as Vardharaja Mannaar" },
            { name: "Shruti Haasan", role: "as Aadhya" },
            { name: "Jagapathi Babu", role: "as Rajamanaar" }
        ],
    ...
    {
        title: "JERSEY", image: "images/movies/jersey.png", rating: "8.5", language: "TELUGU",
        ...
        release: "April 19,2019", runtime: "160 minutes",
         
        producer:"Suryadevara Naga Vamsi",
         cast: [
            { name: "Nani", role: "as Arjun" },
            { name: "Shraddha Srinath", role: "as Sarah" },
            { name: "Sathyaraj", role: "as Murthy" },
            { name: "Harish Kalyan", role: "as Adult Nani (Cameo)" }
        ],
        ...
        reviews: [
            {
                ...
                user: "ranveer",
                daysAgo: 66,
                text: "Jersey is an emotional heart touching movie which is serious in nature,gowtham tinnuri proved himself again after Mallirava..jersey was a complete movie with everything in it,but I felt director would have taken more depth in the way cricket was presented in the movie. Jersey passes everything & its a must watch for telugu audience."
            },
            {
                rating: 5,
                user: "Yogita",
                daysAgo: 83,
                text: "Many films have been made on successful cricketers having fame and wealth. This is the first film made on a failure cricketer showing how these cricketers do their best but remain unfortunate to make it to the national team which doesn't give them enough name, fame, money but go through lots of struggle in life mostly through financial issues.",
            }
        ]
    },
    ...
    {
        title: "JAANU", image: "images/movies/jaanu.png", rating: "7.0", language: "TELUGU",
        ...
        release: "February 7, 2020", runtime: "151 minutes",
         
        producer:"Dil Raju",
         cast: [
            { name: "Sharwanand", role: "as K.Ramachandra / Ram" },
            { name: "Samantha Ruth Prabhu", role: "as S.Janaki Devi / Jaanu" },
            { name: "Gouri G. Kishan", role: "as Young Jaanu" },
            { name: "Vennela Kishore", role: "as Murali" }
        ],
        ...
        reviews: [
            {
                ...
                user: "anitha",
                daysAgo: 63,
                text: "One of the best films that tollywood have ever seen. The whole drama turns around the feelings of Ram and Janu. Good first half with scenes about the reunion of the childhood lovers. Second was very emotional and an unexpected ending. If you have a first crush or first love in your schooling, I'm sure you will connect with the drama."
            },
            {
                rating: 5,
                user: "sunita",
                daysAgo: 63,
                text: "Jaanu successfully achieves the same recreation of the magic which we previously witnessed in the tamil version. Sharwanand and Samantha were at their best in potraying the roles. The songs were soothful. The screenplay could be a bit slow for the telugu audience but the performances dominate everything. Gouri G kishan who played the younger version of Jaanu was so alluring and beautiful you cannot just take your eyes off her. BOTTOMLINE- go watch Jaanu for this valentine's day.",
            }
        ]
    },
    ...
    {
        title: "KALKI 2898-AD", image: "images/movies/kalki.png", rating: "7.0", language: "TELUGU",
        ...
        release: "27 June 2024", runtime: "181 minutes",
         
        producer:"C. Aswani Dutt",
         cast: [
            { name: "Prabhas", role: "as Bhairava" },
            { name: "Amitabh Bachchan", role: "as Ashwatthama" },
            { name: "Kamal Haasan", role: "as Supreme Yaskin" },
            { name: "Disha Patani", role: "as Roxie" }
        ],
        ...
        reviews: [
            {
                ...
                user: "Pradeep",
                daysAgo: 77,
                text: "One of the best movie of 2024. The combination of mythology and facts were blended perfectly to capture the audience. It's set in 2898 AD, where the city of Kasi is humanity's last refuge, ruled by the god king Supreme Yaskin, played by Kamal Haasan. The story spans from the Mahabharata era to the future, focusing on Kalki, Vishnu's final avatar."
            },
            {
                rating: 5,
                user: "sanjay",
                daysAgo: 34,
                text: "'Kalki 2898 AD' is not just a movie, it's an experience that redefines the boundaries of science fiction and epic storytelling. Directed by the visionary filmmaker Nag Ashwin, this film is a tour de force that combines a compelling narrative, breathtaking visuals, and stellar performances, setting a new benchmark for Indian cinema.",
            }
        ]
    },
    ...
    {
        title: "HIT The third case", image: "images/movies/hit3.png", rating: "6.9", language: "TELUGU",
        url: "https://www.youtube.com/embed/kAtfaaUgDRU?si=I3Lo4bQS9x8JHyPx",
        description: "SP Arjun Sarkaar, a ruthless cop who commits a heinous murder, is imprisoned for an unspecified crime. In jail, he is saved by a fellow prisoner named Samuel Joseph from being harmed by inmates he had previously arrested. Later, Arjun narrates his story to Joseph through a series of flashbacks.",
        director: "Sailesh Kolanu", stars: "Nani,Karthi,Adivi Sesh,Srinidhi Shetty", genres: "Action,Crime,Thriller",
        release: "1 May 2025", runtime: "157 minutes",
         
        producer:"Prashanti Tipirineni",
         cast: [
            { name: "Nani", role: "as Arjun Sarkaar" },
            { name: "Karthi", role: "as ACP Veerappan" },
            { name: "Adivi Sesh", role: "as Krishna Dev" },
            { name: "Srinidhi Shetty", role: "as Mrudula" }
        ],
...

    {
        ...
        release: "28 March 2025", runtime: "127 minutes",
         
        producer:"Sai Soujanya",
         cast: [
            { name: "Narne Nithiin", role: "as Ashok" },
            { name: "Ram Nithin", role: "as Manoj" },
            { name: "Sangeeth Shobhan", role: "as Damodhar" },
            { name: "Vishnu Oi", role: "as Ganesh 'Laddu'" }
        ],
        ...
        reviews: [
            {
                ...
                user: "shanti",
                daysAgo: 63,
                text: "The film revolves around five silly casual guys who will meet after their college life for the marriage of their friend laddu. But due to some circumstances the decide to go to Goa for a vacation and there they get involved into a problem unknowingly. What Happened after that you will watch it in theaters."
            },
            {
                rating: 4,
                user: "suman",
                daysAgo: 63,
                text: "I laughed for a long time after seeing the picture, which was truly a picture of a thousand different things. If anyone likes comedy type movies, then they can choose this movie. This is not a thriller or action movie, the entire movie is made on comedy, if anyone likes to watch such comedy movies. Then I think you should watch this movie at least once.",
            }
        ]
    },
    ...
    //tamil movies
    {
        title: "JAILER", image: "images/movies/jailer.png", rating: "7.1", language: "TAMIL",
        ...
        release: "10 August 2023", runtime: "169 minutes",
         
        producer:"Kalanithi Maran",
         cast: [
            { name: "Rajinikanth", role: "as Muthuvel Pandian…" },
            { name: "Vinayakan", role: "as Varman" },
            { name: "Ramya Krishnan", role: "as Vijaya Muthuvel Pandian" },
            { name: "Tamannaah Bhatia", role: "as Kamannah" }
        ],
        ...
        reviews: [
            {
                ...
                user: "ashok",
                daysAgo: 54,
                text: "Nelson, you've truly exceeded expectations with your latest film, 'Jailer'! This movie takes a fresh approach to the thriller genre, blending it seamlessly with your characteristic humor that will leave the audience in stitches. It's an exhilarating dark comedy rollercoaster that keeps you hooked throughout."
            },
            {
                rating: 4,
                user: "Yogita",
                daysAgo: 65,
                text: "This film is a celebration for all the fans of Rajini sir!!! He's back once again in his vintage avatar after Petta! His swag, his style, his dialogue delivery and his fantastic performance! Jailer is a perfect comeback for Rajini sir after the disastrous Annaatthe in 2021.",
            }
        ]
    },
    ...
    {
        title: "NILAVUKU EN MEL ENNADI KOBAM ", image: "images/movies/nilavuku.png", rating: "5.8",
        ...
        release: "21 February 2025", runtime: "	131 minutes",
         
        producer:"Kasthuri Raja",
         cast: [
            { name: "Pavish Narayan", role: "as Prabhu Devachandran" },
            { name: "Mathew Thomas", role: "as Rajesh" },
            { name: "Anikha Surendran", role: "as Nila Karunakaran" },
            { name: "Priya Prakash Varrier", role: "as Preethi" }
        ],
        ...
        reviews: [
            {
                ...
                user: "nikhil",
                daysAgo: 45,
                text: "I loved the movie's stunning visuals and the amazing background score by G. V. Prakash-it really made the film feel extraordinary. However, the story was a real letdown. It felt boring, and many scenes seemed like recycled moments from popular Dhanush films. The hero's dialogue even tried too hard to capture Dhanush's style, coming off as awkward and a bit irritating. The first half was sluggish, and the second half dragged even more. I had high expectations, especially watching it on opening day with a lively crowd, but it just didn't deliver the experience I hoped for. And if you were looking forward to a cameo by Dhanush, you're out of luck. Still, if you're a die-hard Dhanush fan, you might enjoy the numerous references to his iconic scenes. In overall a good feel good movie!"
            },
            {
                rating: 4,
                user: "radhika",
                daysAgo: 79,
                text: "A very light hearted movie. Unpredictable end but enjoyable. The subtle humour throughout the movie is very relaxing. Everyone performs adequately. The guy who plays the hero's friend Rajesh is outstanding. His face is very flexible and in split seconds he moves from one happy expression to a totally different one. Emote any expression effortlessly. Sarath kumar gives a dignified performance. This is a youth film. Oldtimers may criticize the storyline and the care free life of today's youth. But that's for real. GV Prakash's peppy songs and the BGM adds the feel of the movie. Some of the long shots from the cenimatographer...especially night shots are very pleasing. Altogether a very warm entertainer to spend the evening pleasantly. Thanks to Dhanush..the Director.",
            }
        ]
    },
    ...
    {
        title: "DRAGON", image: "images/movies/dragon.png", rating: "7.9", language: "TAMIL",
        ...
        release: "21 February 2025", runtime: "	155 minutes",
         
        producer:"Kalpathi S. Agoram",
         cast: [
            { name: "Pradeep Ranganathan", role: "as Ragavan 'Dragon'" },
            { name: "Anupama Parameswaran", role: "as Keerthi" },
            { name: "Kayadu Lohar", role: "as Pallavi" },
            { name: "Ivana", role: "as Harini Mayilvahanan" }
        ],
        ...
        reviews: [
            {
                ...
                user: "naveen",
                daysAgo: 43,
                text: "As a college student, watching Dragon felt like someone had peeked into my life and turned it into a movie only way more entertaining and heartfelt! This Tamil gem, directed by Ashwath Marimuthu and starring Pradeep Ranganathan, hit me right in the feels with its perfect mix of humor, drama, and those emotional punches that make you want to call your parents and say, Thanks for everything.Dragon isn't just a movieit's a reminder that it's okay to mess up, as long as you find your way back. For a college student like me, caught between exams, breakups, and figuring out life, it was the heartwarming boost I didn't know I needed. Grab your friends, hit the theater, and let this one melt your heart-you won't regret it!"
            },
            {
                rating: 4,
                user: "kamal",
                daysAgo: 71,
                text: "Dragon (2025) is a Tamil film that captures the essence of college life with a blend of humor, heart, and relatable characters. While the film may not reinvent the wheel in terms of storytelling, its charming performances and heartwarming message make it an enjoyable and engaging watch.",
            }
        ]
    },
    ...
    {
        title: "TOURIST FAMILY", image: "images/movies/touristfamily.png", rating: "8.3",
        ...
        release: "29 April 2025", runtime: "128 minutes",
         
        producer:"Yuvaraj Ganesan",
         cast: [
            { name: "M.Sasikuma", role: "as Dharmadas" },
            { name: "Simran", role: "as Vasanthi" },
            { name: "Mithun Jai Sankar", role: "as Nithusan" },
            { name: "Kamalesh Jagan", role: "as Mulli" }
        ],
    ...
    {
        title: "VIKRAM", image: "images/movies/vikram.png", rating: "8.3", language: "TAMIL",
        ...
        release: "3 June 2022", runtime: "174 minutes",
         
        producer:"Kamal Haasan",
         cast: [
            { name: "Kamal Haasan", role: "as Agent Vikram / Karnan" },
            { name: "Vijay Sethupathi", role: "as Santhanam" },
            { name: "Fahadh Faasil", role: "as Amar" },
            { name: "Suriya", role: "as Rolex" }
        ],
    ...
    {
        title: "AMARAN", image: "images/movies/amaran.png", rating: "8.1", language: "TAMIL",
        ...
        release: "31 October 2024", runtime: "169 minutes",
         
        producer:"P.Sreenivasa Goud",
         cast: [
            { name: "Sivakarthikeyan", role: "as Major Mukund Varadarajan" },
            { name: "Sai Pallavi", role: "as Indhu Varghese" },
            { name: "Bhuvan Arora", role: "as Sepoy Vikram Singh" },
            { name: "Rahul Bose", role: "as Col. Amit Singh Dabas" }
        ],
    ...
    //malayalam movies
    {
        title: "MANJUMMEL BOYS", image: "images/movies/manjummelboys.png", rating: "8.2", language: "MALAYALAM",
        ...
        release: "22 February 2024", runtime: "135 minutes",
         
        producer:"Shawn Antony",
         cast: [
            { name: "Soubin Shahir", role: "as Kuttan" },
            { name: "Sreenath Bhasi", role: "as Subhash" },
            { name: "Deepak Parambol", role: "as Sudheesh" },
            { name: "Balu Varghese", role: "as Sixen" }
        ],
    ...
    {
        title: "GYMKHANA", image: "images/movies/gymkhana.png", rating: "7.0", language: "MALAYALAM",
        ...
        release: "25 Apr, 2025", runtime: "2h 20mins",
         
        producer:"Jobin George",
         cast: [
            { name: "Naslen", role: "as Jojo Johnson" },
            { name: "Lukman Avaran", role: "as Antony Joshua" },
            { name: "Ganapathi", role: "as Deepak Panikkar" },
            { name: "Noila Francy", role: "as Sherin" }
        ],
        ...
        reviews: [
            {
                ...
                user: "shiva",
                daysAgo: 26,
                text: "The boys' gang is a definite highlight, bringing genuine laughs with their excellent comic timing. Their camaraderie feels authentic and is a strong anchor for the movie's lighter moments. On the romantic front, while Jojo's attempts to flatter the girls were entertaining, I found myself unexpectedly rooting for him to end up with the one he initially refused to kiss, a testament to the subtle character development at play."
            },
            {
                rating: 5,
                user: "suma",
                daysAgo: 43,
                text: "Alappuzha Gymkhana is simply worth watching. The cinematography in the boxing scenes and fights is superb. The music is good. The entire cast delivered a good performance. The movie starts off at a steady pace in the first hour and then becomes entertaining and engaging. The pre-climax and climax are peak moments. It's a comedy-sports movie, and the director has done a great job, reminiscent of Thallumala.",
            }
        ]
    },
    ...
    {
        title: "AAVESHAM", image: "images/movies/aavesham.png", rating: "7.3", language: "MALAYALAM",
        ...
        release: "11 April 2024", runtime: "159 minutes",
         
        producer:"Nazriya Nazim",
         cast: [
            { name: "Fahadh Faasil", role: "as Ranga" },
            { name: "Hipzster", role: "as Aju" },
            { name: "Mithun Jai Shankar", role: "as Bibin" },
            { name: "Roshan Shanavas", role: "as Shanthan" }
        ],
        ...
        reviews: [
            {
                ...
                user: "ranjith",
                daysAgo: 34,
                text: "Aavesham has a great 1st half and not that great 2nd half. It's a good mix of mass and comedy. It's mostly a FaFa show all through with some catchy comedic moments from Sajin. 1st half is a laughter riot and the whole theatre vibes was crazy. Sushin' music is so hip that it really ups the game in the mass scenes and as bgm. The new comer kids have done a really good job and they doesn't feel like freshers in acting. They also have plenty of comedic presence and felt fresh alltogether. Eventhough the second half lags a bit giving the feeling of trying to find the right pace and place, overall it's a good entertainer."
            },
            {
                rating: 5,
                user: "shirisha",
                daysAgo: 63,
                text: "Some of you may disagree but Mollywood (Malayalam Film Industry) is the best film industry in the entire India. Not because of this movie only but I have seen several movie (Hindi Dubbed Version) earlier which completely changed my mindset toward a movie. Earlier i have a misconception that, creation of a good movie depends only big budget, popular director, popular actor/actress, CGI, VFX etc. But i was completely wrong. Therefore, from past few years my interest severely inclined towards Malayalam movies.",
            }
        ]
    },
    ...
    // TV SHOWS
    {
        title: "BIGBOSS", image: "images/tvshows/bigboss.png", rating: "5.5",
        ...
        release: "16 July 2017", runtime: "60minutes",

        producer:"Deepak Dhar",
         cast: [
            { name: "Nagarjuna Akkineni", role: "Self - Host… " },
            { name: "Kaushal Manda", role: "Self - Contestant" },
            { name: "Tanish", role: "Self - Contestant" },
            { name: "Geetha Madhuri", role: "Self - Contestant" }
        ],
        ...
        reviews: [
            {
                ...
                user: "nithin",
                daysAgo: 34,
                text: "At many times the host from s2-5 were biased with contestants. They should be a little strict and should give punishment whenever the contestants are doing wrong but sometimes they overlook that."
            },
            {
                rating: 1,
                user: "bhanu",
                daysAgo: 74,
                text: "Don't waste time watching this show, it's scripted and brings in celebrities who have no talent. Literally they are worst. The contestants who win the show, don't have any career afterwards because people to don't like them and mostly don't know them. This clearly tells us that the show is scripted...So, please don't waste your time participating in the show.",
            }
        ]
    },
    ...
    {
        title: "STRANGER THINGS", image: "images/tvshows/stranger.png", rating: "8.6",
        ...
        release: "July 15, 2016", runtime: "-",
        producer:"Rand Geiger",
         cast: [
            { name: "Millie Bobby Brown", role: "as Eleven" },
            { name: "Finn Wolfhard", role: "as Mike Wheeler" },
            { name: "Gaten Matarazzo", role: "as Dustin Henderson" },
            { name: "David Harbour", role: "as Jim Hopper" }
        ],
    ...
    {
        title: "ISMART JODI", image: "images/tvshows/ismartjodi.png", rating: "5.0",
        ...
        release: "26 December 2021", runtime: "45minutes",

        producer:"Ohmkar",
         cast: [
            { name: "Ohmkar", role: "host" },
            { name: "Siva jyothi", role: "Contestants" },
            { name: "Malayaja prabhakar", role: "Contestants" },
            { name: "Yashwanthvarsha", role: "Contestants " }
        ],
        ...
        reviews: [
            {
                ...
                user: "sneha",
                daysAgo: 54,
                text: "Great show for all audience! Has elements of wit, fun and just everything. Seeing your favourite celebs play new games is a really nice experience!! Every week has a new game and a new setup which is really interesting. A wait for the weekends is what happens every week, for this is irresistible!!! A must watch."
            },
            {
                rating: 5,
                user: "sravanthi",
                daysAgo: 10,
                text: "this show was really good for an entertainment. while watching the show comedy was extremely good.i hope everyone watching this show for alot fun.",
            }
        ]
    },
    ...
    {
        title: "MAHA BHARATH", image: "images/tvshows/mahabharath.png", rating: "8.9",
        url: "https://www.youtube.com/embed/zP5I4I-tpdk?si=xzky9Efi_hDQkIFa",
        ...
        release: "16 September 2013 ", runtime: "-",
        producer:"	Siddharth Kumar Tewary",
         cast: [
            { name: "Saurabh Raj Jain", role: "as Krishna" },
            { name: "Shaheer Sheikh", role: "as Arjun" },
            { name: "Pooja Sharma", role: "as Draupadi" },
            { name: "Aham Sharma", role: "as Karna" }
        ],
        ...
        reviews: [
            {
                ...
                user: "anand",
                daysAgo: 67,
                text: "I am a BIG fan of B R Chopra's Mahabharat, have seen it 4 times and hence I had never imagined that anyone can match to the level of B. R. Chopra's Mahabharat as that version of great story of Mahabharat was awesome. Each and every character of that Mahabharat is etched in people's mind till date and it is hard to imagine that anyone else can create the same magic on screen with Mahabharat. This fact was reinforced after watching the disastrous and pathetic 'Kahani hamare Mahabharat ki' by Ekta Kapoor which was unceremoniously and rightly so was taken off air midway.. But After watching this version of Mahabharat, I am immensely impressed and I thanks the makers from bottom of my heart for bringing this epic story on screen again by doing much more detailed analysis and showing it with the grandeur and magnificence which it demands!!!"
            },
            {
                rating: 5,
                user: "riya",
                daysAgo: 97,
                text: "I never imagined that this show would be this good until i started watching it.I got hooked to it right from the first episode.The acting,screenplay,direction,BGM are too good except the budget for graphics and vfx which you can strike off considering the amount it needs.They should have promoted it Country wide for the reach.Anyway it got dubbed into some languages which did good.Finally a must watch for any kind of audience.This story is really an epic.",
            }
        ]
    },
    ...
    {
        title: "FAST & FURIOUS", image: "images/tvshows/fastandfurious.png", rating: "8.7",
        ...
        release: "June 22, 2001", runtime: "1h 44mins - 2h 23mins",
        producer:"Vin Diesel ",
         cast: [
            { name: "Vin Diesel", role: "as Dominic Toretto" },
            { name: "Paul Walker", role: "as Brian O'Conner" },
            { name: "Michelle Rodriguez", role: "as Letty" },
            { name: "Jordana Brewster", role: "as Mia" }
        ],
    ...
    {
        title: "RANA NAIDU", image: "images/tvshows/rananaidu.png", rating: "7.2",
        ...
        release: "March 10, 2023", runtime: "-",
        producer:"Karan Anshuman",
         cast: [
            { name: "Venkatesh Daggubati", role: "as Naga" },
            { name: "Rana Daggubati", role: "as Rana Naidu" },
            { name: "Surveen Chawla", role: "as Naina" },
            { name: "Abhishek Banerjee", role: "as Jaffa" }
        ],
    ...
    {
        title: "BREAKING BAD", image: "images/tvshows/breakingbad.png", rating: "9.5",
        ...
        release: "January 20, 2008", runtime: "-",
        producer:"Melissa Bernstein",
         cast: [
            { name: "Bryan Cranston", role: "as Walter White" },
            { name: "Aaron Paul", role: "as Jesse Pinkman" },
            { name: "Anna Gunn", role: "as Skyler White" },
            { name: "Betsy Brandt", role: "as Marie Schrader" }
        ],
...
const MovieDetail = () => {
    ...
    if (!movie) {
        return (
            <div>
                <Header />
                <div style={{ padding: "60px", color: "white", background: "#050e1b", minHeight: "100vh", display:"flex", justifyContent:"center",alignItems:"center" }}>
    ...
    return (
        <div>
            <Header />
            <section className="iterate-banner" style={{ backgroundImage: `url(/${movie.image})` }}>
                <div className="iterate-content">
                    <div className="movie-content">
                        <div className="poster-div">
                            <img src={`/${movie.image}`} alt={movie.title} />
                            <a className='btn-trl' href={movie.url} target="_blank"><span><FaPlay /></span> WATCH TRAILER</a>
                            <a className='btn-tct' href="#"><span><FaCreditCard /></span>BUY TICKET</a>
                        </div>
                        <div className="poster-text">
                            ...
                            <div className="ratingpara">
                                <hr />
                                <p className="rating-star"><span><FaStar /></span> {movie.rating}/10</p>
                                <p>Movie Rating : <span><FaStar /><FaStar /><FaStar /><FaStar /><FaStarHalfAlt /></span></p>
                                <hr />
                            </div>
                            ...
                            {activeTab === "Cast & Crew" && (
                                <section className="castcrew">
                                    <h6><b>DIRECTOR</b></h6>
                                    <hr />
                                    <div className="cast-drt">
                                        <div className="drt-dtl">
                                            <img src="/images/person.png" alt="userimg" width="40px" />
                                ...
                                <section>
                                    ...
                                    {movie.reviews.map((review, index) => (
                                        ...
                                        <div key={index} className="review">
                                            <img src="/images/person.png" alt="user profile" width="40px" height="40px" />
                                            <div>
                                                <a href="#">{review.user}</a>
                                                <p>{"⭐".repeat(review.rating)}</p>
                                                <small>{review.daysAgo} days ago</small><br />
                                                <br />
                                                <p>{review.text}</p>
                                            </div>
                                        </div>
